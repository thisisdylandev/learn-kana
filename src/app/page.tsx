        ...
        <div className="m-auto px-10 py-5 bg-white border border-gray-200 rounded-lg shadow">
          <div className="grid grid-cols-2 gap-x-7">
            <h1 className="text-lg font-bold col-span-2">
              Would you like to practice hiragana or katakana?
            </h1>
            ...
            <h2 className="text-lg font-bold col-span-2 mx-auto">
              Which columns would you like to study?
            </h2>
            <div>
              <div className="form-control">
                <label className="label cursor-pointer">
                  ...
                  <input
                    ...
                    className="checkbox"
                    name="root"
                    onChange={() => handleCheckboxClick('root')}
                  />
                </label>
                <label className="label cursor-pointer">
                  ...
                  <input
                    type="checkbox"
                    className="checkbox"
                    onChange={() => handleCheckboxClick('k')}
                  />
                </label>
                <label className="label cursor-pointer">
                  ...
                  <input
                    type="checkbox"
                    className="checkbox"
                    onChange={() => handleCheckboxClick('s')}
                  />
                </label>
                <label className="label cursor-pointer">
                ...
                <label className="label cursor-pointer">
                  ...
                  <input
                    type="checkbox"
                    className="checkbox"
                    onChange={() => handleCheckboxClick('n')}
                  />
                </label>
                <label className="label cursor-pointer">
                  ...
                  <input
                    type="checkbox"
                    className="checkbox"
                    onChange={() => handleCheckboxClick('combo')}
                  />
                </label>
              </div>
            </div>
              ...
              <div className="form-control">
                <label className="label cursor-pointer">
                  ...
                  <input
                    type="checkbox"
                    className="checkbox"
                    onChange={() => handleCheckboxClick('h')}
                  />
                </label>
                <label className="label cursor-pointer">
                ...
                <label className="label cursor-pointer">
                  ...
                  <input
                    type="checkbox"
                    className="checkbox"
                    onChange={() => handleCheckboxClick('y')}
                  />
                </label>
                <label className="label cursor-pointer">
                ...
                <label className="label cursor-pointer">
                  ...
                  <input
                    type="checkbox"
                    className="checkbox"
                    onChange={() => handleCheckboxClick('w')}
                  />
                </label>
                <label className="label cursor-pointer">
                  ...
                  <input
                    type="checkbox"
                    className="checkbox"
                    onChange={() => handleCheckboxClick('variants')}
                  />
                </label>
              </div>
            </div>
            <button
              className="btn btn-wide col-span-2 mt-5 mx-auto"
              id="btn_begin"
              disabled={isDisabled}
